...
# ╔═╡ 25c11d40-4177-11ed-19d8-5531ce7636c5
using Random

# ╔═╡ d9eb23f7-510a-475a-bf60-fbe16c5ca583
using OpenML

# ╔═╡ b2477b49-1f1a-40e0-9f13-c56aed83915b
Random.seed!(123)

# ╔═╡ 0cf3bf29-ef67-490a-baa9-051e7ddb1f9c
rng = MersenneTwister(123)

# ╔═╡ 3ece0d31-7b95-4f9f-a814-a6a36986af30
rand(rng, 4)

# ╔═╡ bae4f5bc-4561-46fb-954d-d542a58e13ec
columntable = (age = [21, 25, 40], height = [1.57, 3.5, 3.5], married = [true, false, false])

# ╔═╡ dfecbc72-df90-4836-be80-2f31bbc3e2d0
dataframe = DataFrame(columntable)

# ╔═╡ 9280a9ad-517a-4d8d-953c-9fb53ba2a0a1
filter(dataframe) do row
	row.married == false
end

# ╔═╡ 86a8ce5a-5cf7-4cee-a27b-b2839076e607
table = OpenML.load(42638)

# ╔═╡ 09860956-9d94-47e2-844d-de7b60b88f66
table

# ╔═╡ b0400c99-c87b-4b35-9a93-2ded5850113a
df0 = DataFrame(table)

# ╔═╡ 922ea787-b9ce-40f7-b68d-872624585894
describe(df0)

# ╔═╡ ee5dbb44-b3cb-4c35-b8b2-50163cd18897
df0[2, :]

# ╔═╡ 4dc03843-a166-4673-9dc9-de534c081f2c
df0[2, :age]

# ╔═╡ d7821b7c-b4ba-4301-80b3-44532b786679
row = df0[5, :]

# ╔═╡ ee972b2a-ffb3-464d-bd6b-6546dd56efee
row.age

# ╔═╡ bc5aaf85-d46e-4644-b94a-42606002d44a
df0[1:4, :]

# ╔═╡ 479f2a35-2149-4e96-a0aa-316ca8d59641
df0.age

# ╔═╡ f2ffb99d-7933-4321-bfe3-910ed18fc3fc
df0.age[4]

# ╔═╡ 29140a48-d342-4019-84e7-af9fac6a2d00


# ╔═╡ 73c82f55-5bdd-4fa9-9572-dab5da323d74


# ╔═╡ 777c426e-d35b-46e1-b7cc-1501d9626f96


# ╔═╡ 7c6a3c6e-7279-4855-8b69-60aa553cb545


# ╔═╡ dac81be2-12b9-45c5-b2f6-e9b5a06ed66c


# ╔═╡ a5b936a6-d476-46b6-b0a8-a10a1a2fcaf8


# ╔═╡ 1f5bcd4e-6433-42f7-b638-52cc1df87286


# ╔═╡ 393ef71c-ce3a-495c-b631-43db2b328e73


# ╔═╡ e37e7309-6ee2-4605-a0be-db6939554240


# ╔═╡ ec2b7606-6245-4261-aa1d-574940d1b7bc


# ╔═╡ f8f99209-ffbc-4ceb-9e5b-ffe18118d9ae


# ╔═╡ 06726b76-0952-4db8-a284-27559300972f


# ╔═╡ 9a2ce082-45f0-40c3-8b82-134d3b722eb8


# ╔═╡ 4edd1399-e0d0-4ccb-9a49-36c6bbcee9e4


# ╔═╡ 06cb3eef-c35a-4d81-9d0c-a44231725d85


# ╔═╡ e56886f2-91f7-439a-a85b-a4751b3fd152


# ╔═╡ f85f02f2-980d-4a0f-9517-9704754826a2


# ╔═╡ 45cb1346-c6fc-46c4-b802-ca0c60686280


# ╔═╡ 47a643b1-b87e-411f-ad16-ffefd2fec45e
using DataFrames

# ╔═╡ f6d8a469-9aff-4a37-8ac5-7c3907b4fdc9
begin 
	using MLJ
	using DataFrames
end
...
git-tree-sha1 = "5fdcf1723ada2136da977e6e67f063a7c6e23049"
