...
# ╔═╡ b347fb87-ec8e-478f-bca0-d2ec61f5f538
using Distributions

# ╔═╡ 9fcefc8a-91e9-4bc1-b3a3-b4ba918cf26a
using PkgOnlineHelp

# ╔═╡ 0f049923-ddf7-47dc-b301-77861a3a4cec
begin
	using CairoMakie
	CairoMakie.activate!(type = "svg")
end

# ╔═╡ 71e8f390-4173-11ed-3147-2b4ce44e4376
x = 5 #shift + enter (return) key

# ╔═╡ e0ff54d2-671d-4ea4-ad1b-1fa2eb368fd2
x^2

# ╔═╡ 232c1e7f-2d7e-4340-b370-75834add44d3
md"# Chapter 1" #md를 붙이면 마크다운 실행

# ╔═╡ 234fb2b2-3832-489f-9e63-8c86c8769e38
N = 10000

# ╔═╡ 678139b6-6c3d-46fb-a525-8cd781b600eb
begin
	samples = rand(Normal(), N)
	samples = (samples).^2
end

# ╔═╡ 3aadc023-c122-4f52-8dbc-b3521aaca69b
g = fit(Gamma, samples)

# ╔═╡ 2a396406-eded-47ec-bff4-2b71a6be24b8
mean(g)

# ╔═╡ 890b5188-a328-49a0-b7be-5ba3dc736602
pdf(g, 1)

# ╔═╡ 8118c6fe-13c7-423e-a2d1-445086366e70
@docs Distributions

# ╔═╡ 07b14522-cad0-472e-98dc-4780f238cefa


# ╔═╡ cfa1b3e9-86b0-4218-b739-71819e18850e


# ╔═╡ 36a8904d-ab51-4c9e-8d7f-12805b6afa85


# ╔═╡ b8dd6f4a-81cb-4a4a-a479-a43297030364


# ╔═╡ a7e1abc2-4bf7-4d7c-b840-0536a13567bf
...
git-tree-sha1 = "8b5780b22d7835fa9fe308581819b24a7836731f"
uuid = "021381c1-d00a-4861-ba2b-4d077ab1b5cd"
version = "0.2.2"
